...
::vnx::Object USBoardModuleClient::vnx_get_config_object() {
	...
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_return_value)) {
		...
		throw std::logic_error("USBoardModuleClient: invalid return value");
	}
}
...
std::shared_ptr<const ::vnx::ModuleInfo> USBoardModuleClient::vnx_get_module_info() {
...
void USBoardModuleClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void USBoardModuleClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t USBoardModuleClient::vnx_self_test() {
...
vnx::bool_t USBoardModuleClient::is_connected() {
	...
	auto _return_value = vnx_request(_method, false);
	if(auto _result = std::dynamic_pointer_cast<const ::pilot::usboard::USBoardModule_is_connected_return>(_return_value)) {
		return _result->_ret_0;
	} else if(_return_value && !_return_value->is_void()) {
		return _return_value->get_field_by_index(0).to<vnx::bool_t>();
	} else {
...
std::shared_ptr<const ::pilot::usboard::USBoardConfig> USBoardModuleClient::get_config() {
	...
	auto _return_value = vnx_request(_method, false);
	if(auto _result = std::dynamic_pointer_cast<const ::pilot::usboard::USBoardModule_get_config_return>(_return_value)) {
		return _result->_ret_0;
	} else if(_return_value && !_return_value->is_void()) {
		return _return_value->get_field_by_index(0).to<std::shared_ptr<const ::pilot::usboard::USBoardConfig>>();
	} else {
		throw std::logic_error("USBoardModuleClient: invalid return value");
	}
}
