...
std::string USBoardModule_save_config::get_type_name() const {
...
vnx::Variant USBoardModule_save_config::get_field(const std::string& _name) const {
	if(_name == "config") {
...
void USBoardModule_save_config::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "config") {
		_value.to(config);
	} else {
...
std::shared_ptr<vnx::TypeCode> USBoardModule_save_config::static_create_type_code() {
	...
	type_code->native_size = sizeof(::pilot::usboard::USBoardModule_save_config);
