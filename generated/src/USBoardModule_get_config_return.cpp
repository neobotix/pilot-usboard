...
std::string USBoardModule_get_config_return::get_type_name() const {
...
vnx::Variant USBoardModule_get_config_return::get_field(const std::string& _name) const {
	if(_name == "_ret_0") {
...
void USBoardModule_get_config_return::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "_ret_0") {
		_value.to(_ret_0);
	} else {
...
std::shared_ptr<vnx::TypeCode> USBoardModule_get_config_return::static_create_type_code() {
	...
	type_code->native_size = sizeof(::pilot::usboard::USBoardModule_get_config_return);
