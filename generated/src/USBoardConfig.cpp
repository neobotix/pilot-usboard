...
const vnx::Hash64 USBoardConfig::VNX_CODE_HASH(0x7afc4e794d5cd68dull);
...
std::shared_ptr<vnx::TypeCode> USBoardConfig::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x7afc4e794d5cd68dull);
