...
std::string USBoardModule_request_data::get_type_name() const {
...
vnx::Variant USBoardModule_request_data::get_field(const std::string& _name) const {
	if(_name == "groups") {
		return vnx::Variant(groups);
	}
	return vnx::Variant();
}

void USBoardModule_request_data::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "groups") {
		_value.to(groups);
	} else {
...
std::shared_ptr<vnx::TypeCode> USBoardModule_request_data::static_create_type_code() {
	...
	type_code->native_size = sizeof(::pilot::usboard::USBoardModule_request_data);
